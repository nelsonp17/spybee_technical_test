...
import ProgressCard from "@/lib/components/atoms/progressCard";
import Hexagon from "@/lib/components/atoms/hexagon";
import DataTable from "@/lib/components/molecules/dataTable/dataTable";
import { ProjectDataType } from "@/lib/types/server/datatype";
import TitleLinkIcon from "@/lib/components/molecules/title/titleLinkIcon";
import { useProjectStore } from "@/lib/store/projectStore";
import {
  useMetrics,
  useUpcomingDeadlines,
  useUpcomingEvents,
} from "@/lib/hooks/useProjectStats";
import StackedHexagonsTeam from "@/lib/components/molecules/metrics/stackedHexagonsTeam";
...
const Summary = ({ onCloseSummary }: SummaryProps) => {
  ...
  const templateUpcomingEvents = [
    ...
    },
    {
      header: "Equipo",
      render: (row: ProjectDataType) => (
        <div className="flex flex-wrap justify-end mr-3">
