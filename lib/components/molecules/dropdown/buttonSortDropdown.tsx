...
import ButtonFilter from "@/lib/components/atoms/buttons/button_filter";
import { ListFilter } from "lucide-react";
import { useEffect, useRef, useState } from "react";
import DropdownItem from "./dropdownItem";
import { useProjectStore } from "@/lib/store/projectStore";
import { SortProjects } from "@/lib/types/client/sortProjects";
  ...
  return (
    <div>
      <div className="relative inline-block text-left" ref={dropdownRef}>
        ...
        {/* Menú Desplegable */}
        {isOpen && (
          <div className="absolute right-0 z-2 mt-2 md:w-56 w-48 origin-top-right animate-fast rounded-md bg-white shadow-xl border border-gray-300">
            <div className="py-1">
              <DropdownItem
